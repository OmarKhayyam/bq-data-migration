...
hodcounter = 0 ## we will use this as counter for hour of day instead of using a random function
...
while(1):
    ...
    hourofday = hodcounter

    row = [(itemid,quantity,userid,hourofday,(geography,location))]
    if hodcounter == 23:
        hodcounter = 0
    else:
        hodcounter = hodcounter + 1
